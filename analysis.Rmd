...
It returns all p-values (I thought it was only significant p-values).
...
If you want to see the sentence from which the p-values was extracted, do this:
...
#### Count imprecise non-significant p-values
